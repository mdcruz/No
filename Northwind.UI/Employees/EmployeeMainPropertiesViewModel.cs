...
namespace Northwind.UI.Employees
{
    public class EmployeeMainPropertiesViewModel : ViewModel
    {
        ...
        {
            get { return _employee.Department == null ? string.Empty : _employee.Department.Name; }
        }
        ...
        private void ChangeDepartment()
        {
            ...
            {
                _employee.Department = _departmentRepository.GetById(viewModel.SelectedDepartment.Id);
